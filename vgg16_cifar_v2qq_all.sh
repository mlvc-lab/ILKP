...
do
    ...
    do
        ...
        python3 main.py $data -a vgg --layers 16 -j 8 -C -g 0 1 -b 256 -T -Q --qb $qb --ckpt "ckpt_best_q"$qb"_ifl.pth" --lr 0.005 -i
        ...
        python3 main.py $data -a vgg --layers 16 -j 8 -C -g 0 1 -b 256 -T --ckpt "ckpt_best_v2qq_q"$qb"88_ifl.pth" -N -v v2qq --qb $qb --lr 0.005 -i
