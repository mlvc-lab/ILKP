            ...
            do
                if [ "$model" = "resnet" ]; then
                    ...
                    do
                        ...
                        python3 main.py $data -a $model --layers $layer -j 4 -C -g "$1" -b 256 -T --ckpt "ckpt_best_v2q_qa"$qba"b"$qbb"_eps1e-08.pth" -N -v v2q --qba $qba --qbb $qbb --lr 0.01 --chk-save
                    ...
                    python3 main.py $data -a $model -j 4 -C -g "$1" -b 256 -T --ckpt "ckpt_best_v2q_pwd8_pws1_qa"$qba"b"$qbb"_eps1e-08.pth" -N -v v2q --qba $qba --qbb $qbb --lr 0.01 --chk-save
