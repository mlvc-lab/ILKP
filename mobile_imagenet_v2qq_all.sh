...
do
    ...
    do
        ...
        python3 main.py imagenet -a $model --groups 3 -j 16 -C -g 0 1 --wd 4e-5 -p 500 -T -Q --qb $qb --ckpt "ckpt_best_q"$qb"_ifl.pth" --datapath /dataset/ImageNet --lr 0.01 -i
        ...
        python3 main.py imagenet -a $model --groups 3 -j 16 -C -g 0 1 --wd 4e-5 -p 500 -T --ckpt "ckpt_best_v2qq_q"$qb"88_ifl.pth" --datapath /dataset/ImageNet -N -v v2qq --qb $qb --lr 0.01 -i
