        ...
        do
            if [ "$model" = "resnet" ]; then
                ...
                do
                    ...
                    python3 main.py $data -a $model --layers $layer --datapath /dataset/CIFAR -j 8 -C -g "$1" -T --ckpt "ckpt_best_q"$qb".pth" -Q --qb $qb
                ...
                python3 main.py $data -a $model --datapath /dataset/CIFAR -j 8 -C -g "$1" -T --ckpt "ckpt_best_q"$qb".pth" -Q --qb $qb
                rm -f ./checkpoint/*/*/ckpt_rt*_q*_epoch_*.pth
