            ...
            do
                if [ "$model" = "resnet" ]; then
                    ...
                    do
                        ...
                        python3 main.py $data -a $model --layers $layer -j 4 -C -g 0 -E -N --ckpt "ckpt_best_v2qq-epsv2_q"$qb"88_eps"$eps".pth" --qb $qb -eps $eps
                        ...
                        python3 main.py $data -a $model --layers $layer -j 4 -C -g 0 -E -N --ckpt "ckpt_rt1_v2qq-epsv2_q"$qb"88_eps"$eps"_s5_best.pth" --qb $qb -eps $eps
                    done
                else
                    python3 find_similar_kernel.py $data -a $model --ckpt ckpt_best.pth -v v2qq-epsv2 --qb $qb -eps $eps
                    python3 main.py $data -a $model -j 4 -C -g 0 -E -N --ckpt "ckpt_best_v2qq-epsv2_pwd8_pws1_q"$qb"88_eps"$eps".pth" --qb $qb -eps $eps
                    ...
                    python3 main.py $data -a $model -j 4 -C -g 0 -E -N --ckpt "ckpt_rt1_v2qq-epsv2_pwd8_pws1_q"$qb"88_eps"$eps"_s5_best.pth" --qb $qb -eps $eps
                fi
            done
        done
    done
