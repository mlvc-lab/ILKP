...
do
    ...
    do
        ...
        rm -f checkpoint/*/*/ckpt_rt1_v1_epoch_*.pth
        rm -f checkpoint/*/*/ckpt_rt1_v2_epoch_*.pth
        python3 main.py $data -a $model -j 8 -C -g 0 -E --ckpt ckpt_rt1_v1_best.pth -N
        python3 main.py $data -a $model -j 8 -C -g 0 -E --ckpt ckpt_rt1_v2_best.pth -N
    done
done
